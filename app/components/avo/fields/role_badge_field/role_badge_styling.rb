...
module Avo
  module Fields
    class RoleBadgeField
      module RoleBadgeStyling
        ...
        def badge_bg_color
          status_definition&.status_color || DEFAULT_BG
        end
        ...
        def luminance(hex)
          hex = hex.delete('#')
          r, g, b = hex[0..1].to_i(16) / 255.0, hex[2..3].to_i(16) / 255.0, hex[4..5].to_i(16) / 255.0
          rs, gs, bs = [r, g, b].map { |c| c <= 0.03928 ? c / 12.92 : ((c + 0.055) / 1.055)**2.4 }
